    ...
    <div class="container">
        <div class="catalog">
            <form method="post" class="item">
                ...
                <input type="text" name="product" value="Samsung J2 Pro" class="product-name" readonly>
                <input type="text" name="price" value="$ 100.00" class="price" readonly>
            ...
            <form action="" method="post" class="item">
                ...
                <input type="text" name="product" value="HP Notebook" class="product-name" readonly>
                <input type="text" name="price" value="$ 299.00" class="price" readonly>
                <input type="text" name="quantity" id="quantity" value="1" class="quantity"><br>
                <input class="btn" type="submit" name="submit" value="Add to Cart">
            </form>
            <form action="" method="post" class="item">
                <img src="https://www.askmea2z.com/inventory_images/13686.jpg" alt="Panasonic T44 Lite" class="product-image">
                <input type="text" name="product" value="Panasonic T44 Lite" class="product-name" readonly>
                <input type="text" name="price" value="$ 125.00" class="price" readonly>
                <input type="text" name="quantity" id="quantity" value="1" class="quantity"><br>
                <input class="btn" type="submit" name="submit" value="Add to Cart">
            </form>
            <form action="" method="post" class="item">
                ...
                <input type="text" name="product" value="Invicta Mens Pro" class="product-name" readonly>
                <input type="text" name="price" value="$ 65.00" class="price" readonly>
                <input type="text" name="quantity" id="quantity" value="1" class="quantity"><br>
                <input class="btn" type="submit" name="submit" value="Add to Cart">
            </form>
            <form action="" method="post" class="item">
                ...
                <input type="text" name="product" value="Ibagbar Laptop Bag" class="product-name" readonly>
                <input type="text" name="price" value="$ 25.00" class="price" readonly>
                <input type="text" name="quantity" id="quantity" value="1" class="quantity"><br>
                <input class="btn" type="submit" name="submit" value="Add to Cart">
            </form>
            <form action="" method="post" class="item">
                ...
                <input type="text" name="product" value="LED Solar Spotlight" class="product-name" readonly>
                <input type="text" name="price" value="$ 30.00" class="price" readonly>                
                <input type="text" name="quantity" id="quantity" value="1" class="quantity"><br>
                <input class="btn" type="submit" name="submit" value="Add to Cart">
            </form>
        </div>
        <div class="cart">
            <?php echo "<h2>Shopping Cart <p class='cart-total'>" . getProdsNumber() . "</p></h2>"; ?>
            <table>
                <thead>
                    <tr>
